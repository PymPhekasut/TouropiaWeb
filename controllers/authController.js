...
exports.signup = catchAsync(async (req, res, next) => {
  //const newUser = await User.create(req.body); //req.body | create new doc in model then pass in obj from which user should be created
